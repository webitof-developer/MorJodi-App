...
import styles from 'react-native-awesome-alerts/src/styles';
...
export default class AwesomeAlert extends Component {
    ...
    componentDidMount() {
        this.backHandlerSubscription = atomicHwBackHandler(HW_BACK_EVENT, this._handleHwBackEvent);
    }
...
function atomicHwBackHandler(eventName, handler) {
